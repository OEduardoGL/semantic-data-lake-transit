...
def run_ml_pipeline(df_final):
    ...
    # Baseline metrics
    y_baseline = df_final['baseline_median_delay'][train_size+val_size:]
    baseline_metrics = {
    ...
    predictions_df = pd.DataFrame({
        "event_dt": df_final['event_dt'][train_size+val_size:],
        "janela_5min": df_final['janela_5min'][train_size+val_size:],
        "cod_linha": df_final['cod_linha'][train_size+val_size:],
        "cod_veiculo": df_final['cod_veiculo'][train_size+val_size:],
        "y_true": y_test,
        "y_pred": y_pred_test
    })
